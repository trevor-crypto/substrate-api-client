...
pub struct AccountInfoGen<Index, AccountData> {
    ...
    /// The number of other pallets that allow this account to exist. The account may not be reaped
    /// until this and `sufficients` are both zero.
    pub providers: RefCount,
    /// The number of pallets that allow this account to exist for their own purposes only. The
