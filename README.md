...
* [example_generic_extrinsic](/src/examples/example_generic_extrinsic.rs): Compose an extrinsic for any call in any pallet by supplying the pallet and call name as strings.
